...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=180),  # Bisa diubah sesuai kebutuhan
    ...
    # Custom tambahan untuk cookie
    'AUTH_COOKIE': 'access_token',                # Nama cookie untuk access token
    'AUTH_COOKIE_SECURE': False,                  # Set True jika pakai HTTPS
    'AUTH_COOKIE_HTTP_ONLY': True,                # Agar tidak bisa diakses dari JS
    'AUTH_COOKIE_PATH': '/',                      # Path cookie
    'AUTH_COOKIE_SAMESITE': 'Lax',                # Bisa 'Strict' | 'Lax' | 'None'
}
MIDDLEWARE = [
